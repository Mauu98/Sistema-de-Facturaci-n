...
public class JPAUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException { //Obtener al usuario mediante su username.
		...
		for(Role role: usuario.getRoles()) { //Por cada rol que tenga cada usuario..
			logger.info("Role: ".concat(role.getAuthority()));
			authorities.add(new SimpleGrantedAuthority(role.getAuthority())); //Se guardará en la lista authorities.
		}
